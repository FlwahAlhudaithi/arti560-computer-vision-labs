...
vid_path = '/Users/fellwakh/Documents/GitHub/arti560-computer-vision-labs/new/lab08-pose-estimation/media/skydiving.mp4'
...
out = cv2.VideoWriter("skydiving_yolov7.avi", cv2.VideoWriter_fourcc(*'MJPG'), fps, (new_w, new_h))
